  ...
  <div class="my-5" style="width: 36%;margin-left: 32%;">
    <div >
      <div class="row my-3">
        <a style="font-weight: bold;" class="col-5 text-light">Địa chỉ:</a>
        <a class="col-7 text-right"><?php echo $data["address"]?></a>
      </div>
      <div class="row my-3">
        <a style="font-weight: bold;" class="col-5 text-light">Số điện thoại:</a>
        <a class="col-7 text-right"><?php echo $data["phoneNumber"]?></a>
      </div>
      <div class="row my-3">
        <a style="font-weight: bold;" class="col-5 text-light">Email:</a>
        <a class="col-7 text-right"><?php echo $data["email"]?></a>
      </div>
      <div class="row my-3">
        <a style="font-weight: bold;" class="col-5 text-light">Ngày sinh:</a>
        <a class="col-7 text-right"><?php echo $data["dateOfBirth"]?></a>
      </div>
      <div class="row my-3">
        <a style="font-weight: bold;" class="col-5 text-light">Giới tính:</a>
        <a class="col-7 text-right"><?php echo $data["gender"]?></a>
      </div>
